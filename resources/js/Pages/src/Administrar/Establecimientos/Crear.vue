                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-5">
                            <label-general for="nombre_comercial" value="Nombre Comercial" />
                            <input-general id="nombre_comercial" type="text" class="block w-full capitalize" v-model="form.nombre_comercial" autocomplete="nombre_comercail" />
                            <error-general :message="form.error('nombre_comercial')"/>
                        </div>
                        <div class="col-span-6 sm:col-span-5">
...
<script>
    export default {
        ...
        methods: {
            guardar(){
                this.form.post(route('api.establecimientos.crear'), {
